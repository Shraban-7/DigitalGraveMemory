{{ GoogleTranslate::trans('Submit', app()->getLocale()) }}<!DOCTYPE html>
<html lang="en"><head>
          ...
          @endif
            ...
            <form id="sign_in_form" action="{{URL::to("/otp_send")}}" accept-charset="UTF-8" method="post" novalidate="novalidate" data-gtm-form-interact-id="0">
              ...
              <div class="input-group-lg">
                <input type="email" name="mail" class="form-control valid" placeholder="john.doe@address.com" autofocus="autofocus" autocomplete="username" data-gtm-form-interact-field-id="0" aria-invalid="false">
                @csrf
              </div>
