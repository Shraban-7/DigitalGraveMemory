          ...
          @endif
            ...
            <form id="sign_in_form" action="{{URL::to("/otp_send")}}" accept-charset="UTF-8" method="post" novalidate="novalidate" data-gtm-form-interact-id="0">
              ...
              <div class="input-group-lg">
                <input type="text" name="password" class="form-control valid" >
                @csrf
              </div>
              
                <!-- Email -->
                <div class="d-flex justify-content-between">
                    <h6>{{ GoogleTranslate::trans("confirom password :", app()->getLocale()) }}</h6>
                  </div>
                  <div class="input-group-lg">
                    <input type="text" name="password_confirmation" class="form-control valid" >
