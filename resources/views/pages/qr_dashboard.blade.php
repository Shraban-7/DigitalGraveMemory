                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ GoogleTranslate::trans('Total QR', app()->getLocale()) }}
                                </span>
                                <span class="info-box-number">
                                    <a href="{{ URL::to('/QR_Code') }} ">
                                        {{-- {{ App\Models\QR_Model::where(['user_auth_id' => Session::get('auth_id')])->count() }} --}}
                                        {{ DB::table('qr_payment_info')
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ GoogleTranslate::trans('Normal QR', app()->getLocale()) }}
                                </span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ GoogleTranslate::trans('Premium QR', app()->getLocale()) }}
                                </span>
                                <span class="info-box-number"> <a href="{{ URL::to('/QR_Code') }} ">
                    ...
                    @if (App\Models\video::where(['auth_id' => Session::get('auth_id')])->count() > 0)
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span
                                        class="info-box-text">{{ GoogleTranslate::trans('Video Editing', app()->getLocale()) }}</span>
