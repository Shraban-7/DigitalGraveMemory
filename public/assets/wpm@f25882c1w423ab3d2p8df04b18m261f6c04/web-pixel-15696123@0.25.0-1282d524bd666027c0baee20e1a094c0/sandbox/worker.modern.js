function initWebPixel() {
        ...
        (() => {
            ...
            var R = (e, t, i, s) => {
                if (t && typeof t == "object" || typeof t == "function")
                    for (let r of A(t)) !V.call(e, r) && r !== i && m(e, r, {
                        get: () => t[r],
                        enumerable: !(s = S(t, r)) || s.enumerable
                    });
                return e
            };
            var b = (e, t, i) => (i = e != null ? T(O(e)) : {}, R(t || !e || !e.__esModule ? m(i, "default", {
                value: e,
                enumerable: !0
            }) : i, e));
            var f = (e, t, i) => new Promise((s, r) => {
                var p = a => {
                        try {
                            _(i.next(a))
                        } catch (o) {
                    ...
                    _ = a => a.done ? s(a.value) : Promise.resolve(a.value).then(p, u);
            ...
            var I = C(v => {
                ...
                y(({
                    ...
                    if (!s) return;
                    let p = s.myshopifyDomain;
                    t.subscribe("page_viewed", o => f(v, null, function*() {
                        let n = o.context.window.location.href,
                            c = _(n);
                        if (!c) return;
                        yield a(c);
                        let h = o.clientId || (yield i.cookie.get("_shopify_y"));
                        yield u({
                            event: "visit",
                            shop: p,
                            dt_id: c,
                            shopify_uuid: h,
                            shopify_event_id: o.id,
                            page_url: n
                        })
                    })), t.subscribe("checkout_completed", o => f(v, null, function*() {
                        let n = yield i.cookie.get("dt_id");
                        if (n === "") return;
                        let c = o.clientId || (yield i.cookie.get("_shopify_y"));
                        yield u({
                            event: "checkout",
                            shop: p,
                            dt_id: n,
                            ...
                            checkout_token: o.data.checkout.token
                        })
                    }));

                    function u(o) {
                        return f(this, null, function*() {
                            let n = "https://api.dttrk.com/api/shopify/visit";
                            return i.sendBeacon(n, JSON.stringify(o))
                        })
                    }

                    function _(o) {
                        return new URL(o).searchParams.get("dt_id")
                    }

                    function a(o) {
                        let n = new Date,
                            c = new Date;
                        c.setTime(n.getTime() + 90 * 24 * 60 * 60 * 1e3);
                        let h = `dt_id=${o}; expires=${c.toUTCString()};`;
                        return i.cookie.set(h)
                    }
                })
            });
            var tt = b(I());
    ...
    })(self.webPixelsManager.createShopifyExtend('15696123', 'app'));
}
(() => {
    var e = {
            747: function(e, t, r) {
