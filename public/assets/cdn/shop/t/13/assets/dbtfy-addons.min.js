...
function themeAddtocartAnimation() {
    function AddtocartAnimation() {
        const t = theme.settings.dbtfyATCAnimationType,
            ...
            o = `slow ${t}`;
        $(".product-single__add-to-cart .btn--add-to-cart:not([disabled])").addClass("btn--addtocart_animation"), setInterval(function() {
...
function themeAutomaticGeolocation() {} /* end-dbtfy-automatic-geolocation */
...
function themeCartDiscount() {
    function CartDiscount() {
        ...
        t.length && (n.on("keydown", function(t) {
            13 === t.keyCode && (t.preventDefault(), "" !== $(this).val() && $(t.target).closest("form").find("button[name='checkout']").trigger("click"))
        }), $(document).on("click", ".cd-apply", function(t) {
            if (t.preventDefault(), "" !== $(t.target).closest(".CartDiscount").find(".input-cart_discount").val()) {
                var n = $(t.target).closest("form").find("button[name='checkout']");
                n.length || (n = $(t.target).closest("#CartDrawer").find("button[name='checkout']")), n.trigger("click")
            }
        }))
    }
    CartDiscount(), $("body").on("ajaxCart.afterCartLoad", function(t, n) {
        CartDiscount()
    });
}
...
function themeCartDiscountDestroy() {
    ...
    destroyCartDiscount(), $("body").on("ajaxCart.afterCartLoad", function(t, o) {
        destroyCartDiscount()
    });
...
function themeCartFavicon() {
    function CartFavicon() {
        ...
        function n(n) {
            ...
            e && (a > 0 ? o.setAttribute("href", e) : o.setAttribute("href", t)), !e && t && function(e, n) {
                if (e.classList.contains("notification-enabled") && n > 0) return;
                n > 0 ? function(e, n) {
                    const a = document.createElement("img");
                    a.crossOrigin = "anonymous", a.src = t, a.onload = function() {
                        const t = document.createElement("canvas"),
                            n = t.getContext("2d"),
                            o = a.width - a.width / 4.5 - 5,
                            c = a.width / 4.5;
                        t.width = a.width, t.height = a.height, n.clearRect(0, 0, a.width, a.height), n.drawImage(a, 0, 0), n.fillStyle = "#eb361e", n.strokeStyle = "#ffffff", n.lineWidth = 5, n.beginPath(), n.arc(o, 25, c, 0, 2 * Math.PI, !1), n.closePath(), n.fill(), n.stroke();
        ...
        function i(t, e, n, i) {
            ...
            o.sizes = "192x192", o.type = "image/x-icon", o.rel = "shortcut icon", o.id = "favicon", o.href = e, t.remove(), a.appendChild(o), o.classList[i]("notification-enabled")
        }
        t && (n(), $("body").on("ajaxCart.afterCartLoad", function(t, e) {
            n(e)
        }))
    }
    CartFavicon();
...
function themeCartReminder() {
    function CartReminder() {
        ...
        c.length && (theme.isCartLoaded ? (a(), theme.NotificationToast.init(".dbtfy-cart_reminder_wrapper", a, !0)) : document.addEventListener("dbtfy:cartLoaded", function() {
            a(), theme.NotificationToast.init(".dbtfy-cart_reminder_wrapper", a, !0)
        }))
    }
...
function themeCartSavings() {
    function CartSavings() {
            ...
            function c() {
                ...
                d.forEach(a => {
                    function c(a, b, c, d) {
                        ...
                        e && (a.innerHTML = ""), a.innerHTML = b ? `<span class="cart__subtotal-discounted text-sale"><span class="money">${d}</span></span> <span class="cart__subtotal-discounted text-muted text-strike"><span class="money">${c}</span></span>` : `<span class="money">${c}</span>`
                    }
                    ...
                    if (0 < p || 0 < i) {
                        ...
                        const l = d.closest(".main-content") ? "cartCurrentValues" : "drawerCartCurrentValues",
                            q = b[l];
                        if (q.qt != o && q.compareAtPrice === k && n) return;
                        if (q.qt = o, h && (p += i, a = k - p, q.price === a && q.compareAtPrice === k && n)) return;
                        if (q.price === a && q.compareAtPrice === k && n) return;
                        q.price = a, q.compareAtPrice = k;
                        const r = theme.Currency.formatMoney(a, e);
                        j.innerHTML = `<span class="money">${theme.Currency.formatMoney(p,e)}</span>`, c(f, !0, m, r), g && (g.innerHTML = `<span class="money">${r}</span>`, d.removeAttribute("hidden"))
                    } else c(f, !1, m), g && (g.innerHTML = `<span class="money">${m}</span>`, d.setAttribute("hidden", "hidden"))
                })
            }
        ...
        a(), $("body").on("ajaxCart.afterCartLoad", function(b, c, d) {
            a(d)
...
function themeCartSavingsDestroy() {
    ...
    destroyCartSavings(), $("body").on("ajaxCart.afterCartLoad", function(a, r) {
        destroyCartSavings()
    });
...
function themeCartUpsell() {
    function CartUpsell() {
            ...
            r.length && e.items.forEach((e, t) => {
                ...
                n.filter(e => {
                    ...
                    if (r) {
                        ...
                        n && (n.removeAttribute("data-has-submit-event"), n.removeAttribute("data-has-submit-listener"));
        ...
        function GeneralCartUpsell(e) {
            ...
            r.length && r.forEach(e => {
                ...
                if (t) {
                    ...
                    a && (a.removeAttribute("data-has-submit-event"), a.removeAttribute("data-has-submit-listener")), t.querySelector(".ajaxcart__general-upsell") || t.insertAdjacentHTML("beforeend", '\n                  <div class="ajaxcart__general-upsell drawer__inner-section card-group"></div>\n                ');
                ...
                if (r) {
                    ...
                    a && (a.removeAttribute("data-has-submit-event"), a.removeAttribute("data-has-submit-listener"));
        ...
        function addListeners() {
            ...
            cartUpsellButtons.forEach(upsellButton => {
                ...
                isEventAdded ? upsellButton.setAttribute("data-has-click-event", "true") : upsellButton.addEventListener("click", event => {
                    ...
                    if (theme.loadingState.init(button), button.classList.contains("cu-replace-offer")) {
                    ...
                    ShopifyAPI.addItemFromForm(form, () => {
                        ...
                        })) : theme.ajaxCart.update(), document.body.classList.remove("js-modal-open")
                    }, (XMLHttpRequest, textStatus, form) => {
                        const data = eval(`(${XMLHttpRequest.responseText})`);
                        if (theme.loadingState.destroy(button), data.message && 422 === data.status) {
                            const e = button.nextElementSibling;
                            e && e.remove(), button.insertAdjacentHTML("afterend", `<div class="errors qty-error">${data.description}</div>`)
                        }
                    })
                })
            });
        ...
        dbtfy && ($("body").on("ajaxCart.afterCartLoad", function(e, t) {
            t.items.length && (SpecificCartUpsell(t), GeneralCartUpsell(t), addListeners(), $("body").trigger("dbtfy:cartUpsellLoaded", t))
        }), $("body").hasClass("template-cart") && ShopifyAPI.getCart(e => {
            e.items.length && (SpecificCartUpsell(e), GeneralCartUpsell(e), addListeners(), $("body").trigger("dbtfy:cartUpsellLoaded", e))
        }))
    }
    CartUpsell();
}
...
function themeCartUpsellDestroy() {
    ...
    destroyCartUpsell(), $("body").on("ajaxCart.afterCartLoad", function() {
        destroyCartUpsell()
    });
...
function themeCollectionAddtocartDestroy() {} /* end-dbtfy-collection-addtocart */
...
function themeColorSwatchesDestroy() {} /* end-dbtfy-color-swatches */
...
function themeCookieBox() {
    async function CookieBox() {
        ...
        if (!o || !e || e.in_eu) {
            ...
            localStorage.cookieboxClosed || t.show(), i.click((function() {
...
function themeCustomCurrenciesDestroy() {} /* end-dbtfy-custom-currencies */
    ...
    function CustomizableProducts() {
        ...
        function o(e, t) {
            ...
            if (c) c.insertAdjacentElement("beforeend", r);
                ...
                e.classList.add("dbtfy-list-property-fields"), e.insertAdjacentElement("beforeend", r), o.insertAdjacentElement("beforebegin", e)
            }
        }
        document.querySelectorAll(".dbtfy-list-property-fields").forEach((e, t) => {
            ...
            r.forEach((e, r) => {
                ...
                c.forEach(e => {
                    ...
                    c.setAttribute("for", `${e.id}-${t}-${r}-${o}`), e.setAttribute("id", `${e.id}-${t}-${r}-${o}`)
                })
            })
        })
    }
...
function themeDiscountSaved() {
    function DiscountSaved() {
        ...
        b.length && b.forEach(b => {
            ...
            c && (a(c), c.querySelectorAll(".product-form__input, .single-option-selector__radio").forEach(b => {
...
function themeFacebookMessengerDestroy() {} /* end-dbtfy-facebook-messenger */
...
function themeInactiveTabMessage() {} /* end-dbtfy-inactive-tab-message */
...
function themeInfiniteScrollDestroy() {
    function destroyInfiniteScroll() {
        ...
        e && (e.remove(), "undefined" != typeof Ajaxinate && (new Ajaxinate).destroy())
    }
        ...
        b.forEach(a => {
            function b(a) {
                function b() {
                    ...
                    const d = c.querySelector(".btn--add-to-cart, .js-add-to-cart-button"),
                        e = a.parentElement;
                    if (d && d.matches(":disabled")) return a.setAttribute("hidden", "hidden"), void(1 === e.children.length && e.setAttribute("hidden", "hidden"));
                    ...
                    if (!i.length) return a.setAttribute("hidden", "hidden"), null;
                    const j = Array.from(i).some(a => a.classList.contains(`quantity-item-${h}-inventory_quantity`));
                    j.length ? (a.removeAttribute("hidden"), e.removeAttribute("hidden")) : (a.setAttribute("hidden", "hidden"), 1 === e.children.length && e.setAttribute("hidden", "hidden")), i.forEach(b => {
                        if (b.classList.contains(`quantity-item-${h}-inventory_quantity`)) {
                            const c = b.querySelector(".quantity-item-less-threshold-inventory_quantity"),
                                ...
                                k = j - f;
                            0 < k ? (e && (e.innerHTML = k), b.removeAttribute("hidden"), d && (k <= g ? (c.removeAttribute("hidden"), d.setAttribute("hidden", "hidden")) : (c.setAttribute("hidden", "hidden"), d.removeAttribute("hidden")))) : (b.setAttribute("hidden", "hidden"), 1 === i.length && a.setAttribute("hidden", "hidden"))
                ...
                theme.isCartLoaded ? (b(), c()) : document.addEventListener("dbtfy:cartLoaded", function() {
                    b(), c()
                })
            }
            ...
            if (f) {
                ...
                f && (f.addEventListener("change", () => {
                    ...
                    b(d)
                })), b(a), c && d && b(d), document.addEventListener("ProductPageBuilt", () => {
                    b(a)
...
function themeLinkedOptions() {} /* end-dbtfy-linked-options */
    ...
    function MegaMenu() {
        ...
        e.length && e.each((function() {
            var e = $(this),
                ...
                s = e.data("blockid");
            e.insertBefore(a), t(".mm-product-carousel__" + s), t(".mm-images-container__" + s, 3)
        }))
    }
    $(document).on("shopify:section:load", (function() {
        MegaMenu(), theme.dropdown()
    })), MegaMenu();
}
...
function themeMegaMenuDestroy() {
    ...
    document.body.classList.add("dbtfy-mega_menu-destroy"), destroyMegaMenu(), $(document).on("shopify:section:load", function() {
        destroyMegaMenu()
    });
} /* end-dbtfy-mega-menu */
...
function themeMinimumOrderDestroy() {} /* end-dbtfy-minimum-order */
    ...
    function OrderTracking() {
        ...
        t && theme.loadScript(theme.variables.trackingPluginLink, function() {
            t.addEventListener("submit", function(t) {
                t.preventDefault();
                const i = e.value;
                if ("" === i) return alert("Enter your number."), theme.loadingState.destroy(n), void setTimeout(() => {
                    n.removeAttribute("disabled")
                }, 0);
                n.setAttribute("disabled", "disabled"), n.classList.add("btn--loading");
                try {
                    ! function(t) {
                        YQV5.trackSingle({
                    ...
                    setTimeout(function() {
                        n.removeAttribute("disabled"), n.classList.remove("btn--loading")
                    }, 1500)
                }
            })
        })
...
function themeProductBulletPoints() {
    function ProductBulletPoints() {
        ...
        for (const [t, e] of Object.entries(i)) {
            ...
            d.classList.add("pbp-points", "inline-list", ...l), "left" === c ? d.classList.add("text-left") : d.classList.add("text-center"), "newline" === r && (d.style.display = "grid"), e.forEach(t => {
                d.insertAdjacentElement("beforeend", t.cloneNode(!0))
            }), s.insertAdjacentElement("afterend", d)
        }
    }
    ProductBulletPoints(), document.addEventListener("shopify:section:load", t => {
        ProductBulletPoints()
    });
}
...
function themeProductSwatches() {
    function ProductSwatches() {
        ...
        function c(e, t, o, c, r, n) {
            if (e.length) {
                ...
                if (a.classList.add("product_swatches_container"), a.insertAdjacentElement("afterbegin", o), s) {
                ...
                o.hidden = !1, a.hidden = !1, r && (n ? (n.insertAdjacentElement("afterend", a), o.classList.add("list-version")) : (c && c.insertAdjacentElement("afterbegin", a), o.classList.add("card-version")))
            }
        }
        "true" === t && o.forEach(t => {
    ...
    ProductSwatches(), document.addEventListener("dbtfy:addedRecentlyViewedProduct", () => {
        ProductSwatches()
...
function themeProductSwatchesDestroy() {
    ...
    destroyProductSwatches(), document.addEventListener("dbtfy:addedRecentlyViewedProduct", () => {
...
function themeProductTabs() {
    function ProductTabs() {
        ...
        function a(t, e, o, r, c) {
            ...
            if ("description" === e.blockType && t.classList.contains("featured-product-section")) {
                ...
                t.classList.add("tab-content", "rte"), t.innerHTML = `${o.description.replace("<p>[split_description]</p>","").replace("[split_description]","")}`, a.replaceChild(t, i)
            }
        }
        ...
        function i(e, o, r) {
            ...
            n.forEach(n => {
                ...
                !!l && n.contains(l) || n.insertAdjacentHTML("beforeend", i.outerHTML), c ? s && s.remove() : (! function(e, o, r, i) {
                    const n = o.querySelectorAll(".product-tab"),
                        s = document.createElement("div"),
                        l = e.querySelector(".horizontal-tabs-body");
                    s.classList.add("horizontal-tabs-body"), l || o.insertAdjacentHTML("afterend", s.outerHTML);
                    n.forEach((o, n) => {
                        const s = o.id,
                        ...
                        if (!u) {
                            ! function(t, e, o, r) {
                                ...
                                a && a.id !== o.dataset.id && (o.setAttribute("hidden", "hidden"), t.classList.remove("horizontal-tab-active"))
                            }(o, 0, l, e);
                            const t = l.querySelector(".card-body"),
                                n = l.querySelector(".tab-content");
                            a(e, r, i, t, n), d.insertAdjacentHTML("beforeend", l.outerHTML)
                        }
                    }), o.classList.add("horizontal-tab-box")
                }(e, n, o, r), document.querySelectorAll(".horizontal-tab-box .product-tab").forEach(t => {
                    t.hasAttribute("has-click-event") || (t.addEventListener("click", () => {
                        ...
                        }), c.removeAttribute("hidden"), t.classList.add("horizontal-tab-active")
                    }), t.setAttribute("has-click-event", "true"))
                }))
            }), theme.tabs.init(), t.querySelectorAll(".product-tab").forEach(t => {
                t.remove()
            })
        }
        r.forEach(t => {
            t.querySelectorAll(".product-tab").forEach(e => {
                ...
                "reviews" === o && function(t, e, o) {
                    ...
                    if (o) i = e.querySelector(".tab-body .tab-content"), n = e.querySelector("button");
                    else {
    ...
    ProductTabs(), document.addEventListener("shopify:section:load", t => {
        ProductTabs()
    });
}
...
function themeQuantityBreaks() {
    function QuantityBreaks() {
        ...
        const t = {
            ...
            n = {
                add: function(e) {
                    ...
                    if (!t.length) return void sessionStorage.setItem("breaks-discounts", JSON.stringify([e]));
                    t.some((t => t.productId === e.productId)) || (t.push(e), sessionStorage.setItem("breaks-discounts", JSON.stringify(t)))
                },
        ...
        function o() {
            ...
            n && (r(), function(n) {
                ...
                c.classList.add("dbtfy", "dbtfy-quantity_breaks", "qb-cart_break"), i.classList.add("card", "card-body-xs", "text-center", "qb-alert"), u.classList.add("qb-text"), c.appendChild(i), i.appendChild(u);
                ...
                function p(e, n) {
                    let o;
                    o = "$" === e.type ? `<span class="money">${theme.Currency.formatMoney(100*e.amount,t.moneyFormat)}</span>` : `${e.amount}%`, (t.moreDiscountBeforeQuantityText || t.moreDiscountAfterQuantityText || t.moreDiscountAfterPercentageText) && (u.innerHTML = `${t.moreDiscountBeforeQuantityText} <strong class="text-secondary">${n}</strong> ${t.moreDiscountAfterQuantityText} <strong class="text-secondary">${o}</strong> ${t.moreDiscountAfterPercentageText}</div>`)
                }
                let f = m - a,
                    b = d.find((e => e.range === m));
                if (0 === y.indexOf(m) && a < m) p(b, f);
                else if (y.indexOf(m) === y.length - 1) t.highestDiscountText && (u.innerHTML = `<div class="qb-highest-discount-text">${t.highestDiscountText}</div>`);
                else {
                    let e = y.indexOf(m) + 1;
                    for (; e;) {
                        let t = y[e],
                ...
                function h() {
                    ...
                    if (r && r.remove(), n && !n.parentElement.querySelector(".qb-cart_break")) {
                    ...
                    if (a && a.remove(), o && !o.parentElement.querySelector(".qb-cart_break")) {
                        const e = c.querySelector(".qb-text");
                ...
                o.forEach(((e, t) => {
                    ...
                    0 === a ? theme.discountCode.removeAllDiscountsByName(c, {
                        role: "cart-break",
                        needUpdate: !1
                    ...
                    const l = theme.discountCode.getStoredDiscounts(),
                        ...
                        m = s(d, n),
                        p = (document.querySelector("#CartDrawer .qb-product_break_remains, #cartForm .qb-product_break_remains"), theme.settings.dbtfyGiftWrap),
        ...
        function r() {
            ! function() {
                ...
                n < div class = "radio qb-quantity" > \n < input type = "radio"\
                n id = "Quantity-break"\
                n name = "quantity"\
                n value = "${n.dataset.range}"\
                n data - discount - code = "${n.dataset.discountCode}"\
                n data - discount - type = "${n.dataset.discountType}"\
                n data - discount - amount = "${n.dataset.discountAmount}" > \n\ n < label
                for = "Quantity-break" > \n $ {
                    t.singleBreakText
                }\
                n < /label>\n                </div > \n `),"");return e+`\
                n < div class = "qb-product_breaks"\
                n data - show - on - product - page = "${r.showOnProductPage}"\
                n data - visibility - type = "${r.visibilityType}"\
                n data - tags = "${r.tags}"\
                n data - types = "${r.types}"\
                n data - product - id = "${r.productId}"\
                n data - collection = "${r.collection}" > \n\ n < div class = "radio qb-quantity" > \n < input type = "radio"\
                n id = "Quantity-break"\
                n name = "quantity"\
                n value = "1" > \n\ n < label
                for = "Quantity-break" > \n $ {
                ...
                n < /div>\n            `}),"")}\n            </div > \n `;e.insertAdjacentHTML("beforeend",o)}();const o=document.querySelectorAll(t.productSectionSelector);o.length&&(function(n){const o=theme.visibilitySettings.sortVisibilityTypes(e,t.productBreaksSelector);for(let[e,t]of o)t.forEach((e=>{const t={showOnProductPage:e.dataset.showOnProductPage,visibility:e.dataset.visibilityType,tags:e.dataset.tags,types:e.dataset.types,productId:e.dataset.productId,collection:e.dataset.collection,template:e.cloneNode(!0)};n.forEach((e=>{const n=e.querySelector(".product-info-JSON");if(!n)return;const o=JSON.parse(n.innerHTML);theme.visibilitySettings.checkForVisibility(o,t,(function(){a(e,t)}))}))}));const r=e.querySelector(t.productBreaksContainerSelector);r&&r.remove()}(o),document.querySelectorAll(t.productBreaksSelector).forEach(((e,n)=>{e.querySelectorAll(t.quantitySelector).forEach(((e,t)=>{const o=e.querySelector("label"),r=e.querySelector("input");o.setAttribute("for",`
                $ {
                    r.id
                } - $ {
                    n
  ...
  c=r.slice().reverse().find((e=>e.breakCount<=a)),i=c?c.discount:null,u=theme.discountCode.getStoredDiscounts(),d=s(theme.discountCode.getMostValuableDiscount(u,e),e),l=s(i,e),y=e.total_price,m=r.find((t=>{const n=s(t.discount,e);return t.breakCount>a&&n>d})),p=m?m.discount:null,f=s(p,e);let b='<div class="dbtfy dbtfy-quantity_breaks qb-product_break"><div class="card card-body-xs text-center qb-alert qb-product_break_remains">';if(l>d)b+=f>l&&f<=y?h():q();else{const t=theme.discountCode.getStoredDiscounts(),n=s(theme.discountCode.getMostValuableDiscount(t,e),e);b+=f>n&&f<=y?h():q()}function h(){let e="";const n=m.breakCount-a;let o=`
                $ {
                    p.amount
                } % `;return"$"===p.type&&(o=` < span class = "money" > $ {
                    theme.Currency.formatMoney(100 * p.amount, t.moneyFormat)
                } < /span>`),(t.moreDiscountBeforeQuantityText||t.moreDiscountAfterQuantityText||t.moreDiscountAfterPercentageText)&&(e+=`<div class="qb-text">${t.moreDiscountBeforeQuantityText} <strong class="text-secondary">${n}</strong > $ {
                    t.moreDiscountAfterQuantityText
                } < strong class = "text-secondary" > $ {
                    o
                } < /strong> ${t.moreDiscountAfterPercentageText}</div > `),e}function q(){return t.highestDiscountText&&d>0?` < div class = "qb-highest-discount-text" > $ {
                    t.highestDiscountText
                } < /div>`:""}b+="</div > < /div>",e.items.forEach((e=>{const t=e.product_id;if(t!==o)return;document.querySelectorAll(`.cart__row[data-product-id='${t}']`).forEach((e=>{const t=e.closest(".ajaxcart-form");if(e.querySelectorAll(".dbtfy-quantity_breaks").forEach((e=>{e.remove()})),e.insertAdjacentHTML("afterbegin",b),t){const t=e.querySelector(".qb-product_break");t&&t.classList.add("spacer-bottom")}}))}));const S=$("#currency-list-header[name='dbtfy-custom-currencies']"),g=theme.strings.shopCurrency;S.length&&Currency.convertAll(g,Currency.currentCurrency,".qb-alert .money"),theme.discountCode.init()}))}()}function a(e,n){if(!e)return;const o=e.querySelectorAll(t.productBreaksSelector),r=document.querySelector(".quantity-sticky_addtocart");r&&r.remove(),o.forEach((e=>{e.remove()}));const a=e.querySelector(".product-single__quantity"),c=a.querySelector(".qty-container");for(a.querySelector(".inline-label").removeAttribute("hidden");c.firstChild;)c.removeChild(c.lastChild);const s=n.template.cloneNode(!0),i=document.body.classList.contains("template-product");"true"!==s.dataset.showOnProductPage&&i?c.setAttribute("hidden","hidden"):c.removeAttribute("hidden"),c.insertAdjacentElement("beforeend",s)}function c(e){const n=e.target.closest(t.productSectionSelector);if(!n)return;const o=n.querySelector("[id^='MainProductSelect']").querySelector("option:checked"),r=o?+o.value:null,a=n.querySelectorAll(t.quantitySelector),c=n.querySelector(".mainProductJson");if(!c)return;const s=JSON.parse(c.innerHTML).variants.find((e=>e.id===r));if(s){a.forEach((e=>{const n=e.querySelector("label"),o=e.querySelector("input"),r=+o.value,a=o.dataset.discountType,c=+o.dataset.discountAmount,i=!!t.singleBreakPriceType&&t.singleBreakPriceType.includes("single");let u=s.price,d=s.compare_at_price,l=t.singleBreakText,y="";if(l=l.replace("_COUNT_",r),r>1)switch(d=i?u:u*r,a){case"$":i?(y=`<span class="money">${theme.Currency.formatMoney(100*c/r, t.moneyFormat)
        } < /span>`,u=d-100*c/r): (y = `<span class="money">${theme.Currency.formatMoney(100*c,t.moneyFormat)}</span>`, u = d - 100 * c);
    break;
    case "%":
        u = d - d / 100 * c, y = `${c}%`
}
if (r > 1 && !c || u < 0 || d < 0 ? e.setAttribute("data-invalid-value", "true") : e.removeAttribute("data-invalid-value"), l = d ? l.replace("_PRICE_", `\n                  <span class="qb-price text-money">\n                    <span class="qb-discounted-price on-sale text-sale" data-price="${u}">\n                      <span class="money">\n                        ${theme.Currency.formatMoney(u,t.moneyFormat)}\n                      </span>\n                    </span>\n\n                    <span class="qb-original-price text-strike text-muted" data-compare-price="${d}">\n                      <span class="money">\n                        ${theme.Currency.formatMoney(d,t.moneyFormat)}\n                      </span>\n                    </span>\n                  </span>\n                `) : l.replace("_PRICE_", `\n                  <span class="qb-price text-money">\n                    <span class="money">\n                      ${theme.Currency.formatMoney(u,t.moneyFormat)}\n                    <span>\n                  </span>\n                `), r > 1) {
    const e = theme.strings.saveLabel.replace("\{\{ saved_amount \}\}", y);
    l = l.replace("_SAVED_AMOUNT_", `\n                  <span class="badge qb-saved-amount">\n                    ${e}\n                  </span>\n                `)
    ...
    function n(e, t) {
        t.forEach((t => {
            const n = t.querySelector("input"),
                o = +n.value;
            1 === o && (n.checked = !0), o > e || t.hasAttribute("data-invalid-value") ? t.setAttribute("hidden", "hidden") : t.removeAttribute("hidden")
        }))
    }
}();
...
function s(e, t, n) {
    ...
    n(), document.addEventListener("dbtfy:upsellPopupLoaded", (() => {
        n()
    })), $("body").on("ajaxCart.afterCartLoad", (function(e, t) {
        n()
    })), setTimeout((() => {
                ...
                a.forEach((e => {
                    ...
                    function(n, o) {
                        ...
                        if (o.discountCode) {
                            ...
                            c && (r = `${r}&discount=${c.name}`), theme.discountCode.removeAllDiscounts()
                        }
                        a.forEach((e => {
                            let t = !1;
                            if (c.includes(e)) t = !0;
...
QuantityBreaks(), document.addEventListener("shopify:section:load", (e => {
    QuantityBreaks()
}));
}
...
function themeQuantityBreaksDestroy() {
    ...
    document.body.classList.add("dbtfy-quantity_breaks-destroy"), destroyQuantityBreaks();
...
function themeQuickViewDestroy() {} /* end-dbtfy-quick-view */
...
function themeShopProtect() {
    function ShopProtect() {
        ...
        setTimeout(function() {
            i(), d()
        }, 1e3), o && $(".product-single__description, .qv-description, .tab-content").addClass("dbtfy-shop_protect-text"), n && $(".article-section, .blog-section").addClass("dbtfy-shop_protect-text"), c && ($("#sortBy option[value='best-selling']").remove(), "?sort_by=best-selling" === window.location.search && window.location.replace("/collections")), $("body").on("ajaxCart.afterCartLoad", function(t, e) {
            i(), d()
        })
    }
    ShopProtect(), document.addEventListener("QuickViewLoaded", () => {
        ShopProtect()
...
function themeStickyAddtocart() {
    function StickyAddtocart() {
        ...
        let c, a = t.dataset.position,
            i = t.querySelectorAll(".image-sticky_addtocart"),
            o = document.querySelector(".product-single__add-to-cart .btn--add-to-cart"),
        ...
        function v() {
            ...
            if (e.innerHTML = `<span class="money">${theme.Currency.formatMoney(i,m)}</span>`, i < o) {
                if (n.innerHTML = `<span class="money">${theme.Currency.formatMoney(o,m)}</span>`, n.style.display = "inline-block", e.classList.add("text-sale"), r && s) {
                    let t = r.dataset.discountVariant,
                        e = function(t, e, n) {
                            let r = null;
                            if ("percentage" === n) r = `${Math.floor(100*(e-t)/e)}%`;
                            else {
                                let n = e - t;
                    ...
                    c.innerHTML = theme.strings.saveFormat.replace(/\{\{ saved_amount \}\}/, n), r.style.display = "inline-block"
                }
            } else n.style.display = "none", e.classList.remove("text-sale"), r && (r.style.display = "none");
        ...
        function Q() {
            ...
            n > 0 && r ? (u.removeAttribute("disabled"), l.innerHTML = theme.strings.addToCart) : (u.setAttribute("disabled", "disabled"), l.innerHTML = theme.strings.soldOut), document.dispatchEvent(new CustomEvent("stickyATCButtonStateChanged"))
        }

        function q(t) {
            document.querySelector(".featured-product-section [data-section-type='product-template']") || t && !t.includes("no-image") && (i[1].src = t)
        }
        window.updateStickyAtcVariant = !0, b && (c = b.querySelector("input")), window.addEventListener("scroll", (() => {
            window.pageYOffset > y ? (s.classList.add(f), h && document.body.classList.add(h), S = !0) : S && (S = !1, theme.closeTransition({
            ...
            return t.preventDefault(), t.stopImmediatePropagation(), r && setTimeout((() => {
                theme.loadingState.destroy(u)
            }), 0), !1
        })), theme.ProductQuantities.setMaxQuantity(b, k, c), theme.ProductQuantities.setVariantQuantities(b, k, c), theme.ProductQuantities.syncQuantityInputs(c), theme.ProductQuantities.checkQuantity(b, k, c), v(), Q(), b && b.querySelectorAll("button").forEach((t => {
            t.addEventListener("click", (t => {
                theme.ProductQuantities.checkQuantity(b, k, c), theme.ProductQuantities.syncQuantityInputs(c)
            }))
        })), k && k.addEventListener("change", (async e => {
            let n = e.target,
                r = n.options[n.selectedIndex].dataset.image,
                a = n.options[n.selectedIndex].dataset.price;
            q(r), theme.ProductQuantities.setMaxQuantity(b, k, c), theme.ProductQuantities.checkQuantity(b, k, c), theme.ProductQuantities.syncQuantityInputs(c), Q(), t.querySelector(".total-sticky-price").innerHTML = `<span class="money">${theme.Currency.formatMoney(a,m)}</span>`, v();
            let i = document.querySelector("#currency-list-header[name='dbtfy-custom-currencies']"),
                o = theme.strings.shopCurrency;
            i && Currency.convertAll(o, Currency.currentCurrency, ".dbtfy-sticky-price-box .money"), window.updateStickyAtcVariant && theme.syncedProductVariant(n, "sticky")
        })), e.forEach((t => t.addEventListener("change", (t => {
            if (!window.updateStickyAtcVariant) return;
            let e = k.querySelector(`option[value="${n.value}"]`);
            !r.classList.contains("variant-unavailable") && e && (k.value = n.value, q(n.options[n.selectedIndex].dataset.image), Q(), v())
...
function themeStickyAddtocartDestroy() {
    ...
    document.body.classList.add("dbtfy-sticky_addtocart-destroy"), destroyStickyAddtocart();
} /* end-dbtfy-sticky-addtocart */

/* start-dbtfy-synced-variant-image */
function themeSyncedVariantImage() {} /* end-dbtfy-synced-variant-image */
...
function themeTrustBadgeDestroy() {
    ...
    document.body.classList.add("dbtfy-trust_badge-destroy"), destroyTrustBadge(), $("body").on("ajaxCart.afterCartLoad", ((t, d) => {
        destroyTrustBadge()
    }));
...
function themeUpsellBundles() {
    function UpsellBundles() {
        ...
        function upsellBundleLoaded() {
            ...
            if (window.updateBundleVariant = !0, !currentImageUpsell) return void dbtfy.setAttribute("hidden", "hidden");
            ...
            imageWrapperBox.insertAdjacentElement("afterbegin", currentImageUpsell), formWrapperBox.insertAdjacentElement("afterbegin", currentFormUpsell), "button" === position && addUpsellToProductSection(), listCheckboxes.forEach(e => e.addEventListener("click", t => {
                const n = e.dataset.productId,
                    o = e.dataset.index,
                    s = document.querySelector(`.grid-image-${n}-${o}`),
                    l = document.querySelector(`#upsellBundles-${n}-${o}`);
                s.classList.toggle("selected-image-upsell_bundles"), l.classList.toggle("active-upsell_bundles"), verifyUnchecked(), checkPrice()
                ...
                l.forEach(e => e.style.display = "none"), s && (s.style.display = "block"), u > d ? (c.classList.remove("text-sale"), a && (a.style.display = "none")) : (c.classList.add("text-sale"), a && (a.style.display = "inline-block")), c && (c.innerHTML = `<span class="money">${theme.Currency.formatMoney(u,moneyFormat)}</span>`, a.innerHTML = `<span class="money">${theme.Currency.formatMoney(d,moneyFormat)}</span>`), checkPrice(), e.closest(".current-form-upsell_bundles") && window.updateBundleVariant && theme.syncedProductVariant(e, "bundle")
                ...
                !productTemplateMetaContainer.classList.contains("variant-unavailable") && n && (t.value = masterSelect.value, t.dispatchEvent(new Event("change")))
            })), checkPrice(), $buttonBundle.addEventListener("click", e => {
                ...
                forms.forEach(e => {
                    ...
                    if (isDiscountApplicable()) {
                        ...
                        upsellBundleStorage.remove(productId), upsellBundleStorage.add(t), discountName && discountType && discountAmount && theme.discountCode.addDiscount(discountName, discountType, discountAmount), theme.discountCode.init()
                    }
                    theme.loadingState.init($buttonBundle), theme.settings.dbtfySkipCart ? theme.goToCheckoutWithDiscount() : "page" === cartType ? document.body.classList.contains("template-cart") ? theme.ajaxCart.update() : window.location.assign("/cart") : "drawer" === cartType ? (theme.ajaxCart.update(), $("body").on("ajaxCart.afterCartLoad", function(e, t) {
                        theme.loadingState.destroy($buttonBundle)
                    })) : (theme.ajaxCart.update(), $("body").on("ajaxCart.afterCartLoad", function(e, t) {
                        theme.loadingState.destroy($buttonBundle), theme.settings.enableCartMessage && window.initNotificationToast || theme.cartModal.init()
                    }))
                }, (XMLHttpRequest, textStatus, form) => {
                    const data = eval(`(${XMLHttpRequest.responseText})`);
                    theme.loadingState.destroy($buttonBundle), data.message && 422 === data.status && $buttonBundle.insertAdjacentHTML("afterend", `<div class="errors qty-error">${data.description}</div>`)
                })
            });
            const upsellBundleStorage = {
                ...
                add: function(e) {
                    const t = this.getAll() || [];
                    t.push(e), sessionStorage.setItem("upsellBundles", JSON.stringify(t))
                },
                has: function(e) {
                    const t = this.getAll();
                ...
                remove: function(e) {
                    ...
                    return n.length ? sessionStorage.setItem("upsellBundles", JSON.stringify(n)) : sessionStorage.removeItem("upsellBundles"), !0
                }
            };

            function calculateDiscount(e, t) {
                let n = null;
                if (discountBox && (discountBox.style.display = "none"), bundleTotal.classList.remove("text-sale"), t > e) {
                    ...
                    n && (discountBoxText && (discountBoxText.innerHTML = theme.strings.saveFormat.replace(/\{\{ saved_amount \}\}/, n)), bundleTotal.classList.add("text-sale"), discountBox && (discountBox.style.display = "block"))
                }
            }
            ...
            function checkPrice() {
                ...
                if ($bundleSelect.forEach(e => {
                    ...
                    t > 0 ? (n = e, $container.setAttribute("data-discount-applied", "true")) : (t = e, $container.removeAttribute("data-discount-applied"))
                }
                bundleTotal.dataset.total = t, bundleTotal.innerHTML = `<span class="money">${theme.Currency.formatMoney(t,moneyFormat)}</span>`, t < n ? (bundleCompareTotal.dataset.total = n, bundleCompareTotal.innerHTML = `<span class="money">${theme.Currency.formatMoney(n,moneyFormat)}</span>`, bundleCompareTotal.style.display = "block") : bundleCompareTotal.style.display = "none", calculateDiscount(t, n);
            ...
            function verifyUnchecked() {
                ...
                t.length === n.length ? (e.classList.add("disabled"), e.setAttribute("disabled", "disabled")) : (e.classList.remove("disabled"), e.removeAttribute("disabled", "disabled"))
            }
            ...
            function isDiscountApplicable() {
                ...
                let n = !1;
                return Array.from(e).reduce((e, t) => t.checked ? e + 1 : e, 0) === e.length && t && (n = !0), n
            }
        ...
        function getRecommendationsSection() {
            fetch(recommendationsSectionUrl).then(function(e) {
                ...
                t && "" !== t.trim() && ($container.innerHTML = t, upsellBundleLoaded())
            })
        }
...
function themeUpsellPopup() {
    ...
    async function UpsellPopup() {
        async function a() {
            ...
            c.insertAdjacentHTML("afterbegin", p), theme.openExternalLinksInANewTab(), document.dispatchEvent(new CustomEvent("dbtfy:upsellPopupMarkupLoaded"))
        }

        function b() {
            theme.tabs.init(), theme.modal.init(), theme.discountCode.init(), theme.loadingState.initForm(), theme.ajaxCart.init(), theme.styleTextLinks();
            var a = $("form[action*='/cart/add']"),
                b = $(".up-checkout-link"),
                c = $(".up-progress-bar"),
                d = theme.settings.cartType,
                e = $("#UpsellPopup-general");
            if (e.length) a.attr("data-has-submit-listener", "true");
            else {
            ...
            a.off("submit"), a.attr("data-has-submit-listener", "true"), a.on("submit", function(a) {
                onFormSubmit(this, a, !0)
            }), onFormSubmit = function(f, g, h) {
                function i() {
                    o.off("click"), b.off("click"), t.off("change"), m.off("modal.close"), theme.loadingState.destroy(o)
                }

                function j(a, b) {
                    const c = a.get(0);
                    a.removeAttr("data-has-submit-listener"), b ? theme.ajaxCart.update() : c.dispatchEvent(new CustomEvent("form-submit")), a.attr("data-has-submit-listener", "true")
                }
                var k = $(f),
                ...
                if (!k.attr("data-has-submit-listener") && h) return;
                if (k.hasClass("up-form")) return;
                if (m.length) g && g.preventDefault();
                else if (r && r.length) g && g.preventDefault(), m = r[0];
                else if (e.length) g && g.preventDefault(), m = e;
                else return void j(k, !h);
                var s = m.find(".up-img"),
                    t = m.find(".up-select"),
                    u = m.find(".up-form"),
                    v = m.data("offer"),
                ...
                return z || m.hasClass("up-offer-accepted") ? void j(k, !h) : void(o.click(function() {
                    k.removeAttr("data-has-submit-listener"), m.addClass("up-offer-accepted"), w && x && y && theme.discountCode.addDiscount(w, x, y, {
                        productTriggerId: +l,
                        productOfferId: +v,
                        role: "upsell-popup"
                    }), c.css("width", "100%"), ShopifyAPI.addItemFromForm(u, () => {
                        theme.modal.close(m);
                        theme.settings.enableCartMessage && window.initNotificationToast || (document.dispatchEvent(new CustomEvent("dbtfy:upsellPopupLoaded")), setTimeout(() => {
                            c.css("width", "75%")
                        }, 2e3), theme.settings.dbtfySkipCart && theme.goToCheckoutWithDiscount())
                    })
                }), h ? function() {
                ...
                }() : theme.modal.open(m), m.on("modal.close", function() {
                    return i(), theme.settings.dbtfySkipCart ? void theme.goToCheckoutWithDiscount() : void("page" === d ? !document.body.classList.contains("template-cart") && window.location.assign("/cart") : "drawer" === d ? (theme.ajaxCart.update(), $("body").on("ajaxCart.afterCartLoad", () => {
                        a.attr("data-has-submit-listener", "true")
                    })) : (theme.ajaxCart.update(), $("body").on("ajaxCart.afterCartLoad", () => {
                        theme.settings.enableCartMessage && window.initNotificationToast || theme.cartModal.init()
                    })))
                }), b.on("click", function() {
                    theme.loadingState.init(b), theme.ajaxCart.update(() => {
        ...
        c && (theme.isCartLoaded ? (await a(), b()) : document.addEventListener("dbtfy:cartLoaded", async () => {
            await a(), b()
        ...
        if (b && a) {
            ...
            if (b.length) {
                ...
                c.length && (c.forEach(b => {
                    ...
                    e || c === d || theme.discountCode.removeDiscount(b.name), theme.discountCode.init(a)
    ...
    function UpsellNotInCart(a) {
        ...
        if (b && a) {
            ...
            b.length && b.forEach(b => {
                ...
                b.classList.contains("up-offer-accepted") && (e && !f ? b.classList.remove("up-offer-accepted") : !f && b.classList.remove("up-offer-accepted")), f || e || b.classList.remove("up-offer-accepted")
            })
        }
    }
    $("body").on("ajaxCart.afterCartLoad", (a, b) => {
        UpsellCouponCode(b), UpsellNotInCart(b)
...
function themeUpsellPopupDestroy() {
    ...
    document.body.classList.add("dbtfy-upsell_popup-destroy"), destroyUpsellPopup(), $("body").on("afterRecommendationLoad", function(e) {
        destroyUpsellPopup()
    }), document.addEventListener("QuickViewLoaded", () => {
        destroyUpsellPopup()
    });
...
function addonsLimitReached() {
    ...
    const n = d.querySelectorAll(".to-link-btn, [data-toast-close]"),
        ...
        l = s[c.nextAddon];
    a.innerHTML = a.innerHTML.replace("[plan_name]", c.name).replace("[current_limit]", c.maxAddons).replace("[upgraded_plan]", `<a class="text-link" href="${l.link}">${l.name}</a>`).replace("[upgraded_limit]", l.maxAddons), y.innerHTML = y.innerHTML.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replaceAll("[current_limit]", c.maxAddons), m.href = l.link, theme.toast.show(d), n.forEach((e => {
        e.addEventListener("click", (e => {
            sessionStorage.setItem("addonsLimitPopupClosed", "true"), theme.toast.hide(d)
        }))
    }))
}
